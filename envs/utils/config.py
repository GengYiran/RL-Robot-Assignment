...
def retrieve_cfg(args, use_rlg_config=False):
    ...
    if args.task == "OneFrankaCabinet":
        ...
        log_dir = os.path.join(args.logdir, "franka_door/{}/{}".format(args.algo, args.algo))
        algo_cfg = "cfg/{}/opendoor_config.yaml".format(args.algo)
        task_cfg = "cfg/franka_door_open.yaml"
